...
// import static org.springframework.security.config.Customizer.*; a65eea7c-9e62-4014-9a10-8772a798b5dc
...
public class SecurityConfig { 
    ...
    //     http
    //         .authorizeRequests()
    //             .requestMatchers("/**", "/js/**", "/css/**", "/login.html", "/about.html", "/api/**").permitAll() //!I have included the select pages i want access before logging in.
    ...
    //             .and().csrf().disable(); // This removes the error for creating new entity 
    //     return http.build();
    //     }   
