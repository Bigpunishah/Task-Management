...
public class UserController {
    ...
    public ResponseEntity<String> authenticateUser(@RequestParam String sd, @RequestParam String password) {
        // Authenticate the user based on email and password
        boolean isAuthenticated = userService.authenticateUser(sd, password);
