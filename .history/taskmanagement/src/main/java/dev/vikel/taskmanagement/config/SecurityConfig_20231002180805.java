    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests((authz) -> authz
                ...
                .requestMatchers("/about.html").permitAll() //include the controller mapping URL's EX: about.html can be accessed by /about
...
//.hhtpBasics() is small window pop up
//.formLogin() is the form page
